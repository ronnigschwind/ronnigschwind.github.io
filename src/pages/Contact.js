...
function Contact() {
    return (
      <div className="Contact" style={{textAlign: 'center', maxWidth: 800, margin: 'auto', padding: '0 20px 50px'}}>
        <h1 style={{textAlign: 'center', padding: '50px 20px', fontSize: 50, margin: 'auto'}}>Contact Me For Career or Personal Project Opportunities</h1>
        <p>
